...
| **emdash** | YC W26 — desktop app to run 20+ coding agents in parallel with git worktrees | [generalaction/emdash](https://github.com/generalaction/emdash) | Open source | General Action (YC W26) | 1,527 |
